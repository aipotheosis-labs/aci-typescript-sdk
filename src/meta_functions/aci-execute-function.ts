...
const aciExecuteFunctionBaseSchema: BaseSchema = {
  ...
  description:
    'Execute a specific retrieved function. Provide the executable function name, and the required function parameters for that function.',
  parameters: {
    type: 'object',
    properties: {
      function_name: {
      ...
      function_arguments: {
        type: 'object',
        description:
          'A dictionary containing key-value pairs of input parameters required by the specified function. If the function requires no parameters, provide an empty object.',
 ...
 */
export const wrapFunctionArgumentsIfNotPresent = (obj: {
  [key: string]: object;
}): { [key: string]: object } => {
